...
import lottieJson from '../public/assets/coding.json';
      ...
      <div className="grid grid-flow-row sm:grid-flow-col grid-rows-2 md:grid-rows-1 sm:grid-cols-2 gap-8">
        ...
        <div className=" flex flex-col justify-center items-start row-start-2 sm:row-start-1">
          <h1 className="text-3xl lg:text-4xl xl:text-5xl font-medium text-black-600 leading-normal">
            Siap kerja jadi programmer bersama <strong>PotensiUp</strong>.
          </h1>
            ...
            >
              <div className="flex mx-auto w-40 sm:w-auto">
                <div className="flex items-center justify-center bg-cyan-100 w-12 h-12 mr-6 rounded-full">
                  <FontAwesome name={listUsers.icon} className="h-6 w-6 text-cyan-500"/>
                </div>
